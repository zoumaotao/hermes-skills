...
TOOLSETS = {
    ...
    "feishu_doc": {
        "description": "Feishu/Lark document and drive operations (read, create, upload, import)",
        "tools": [
            "feishu_doc_read", "feishu_doc_create",
            "feishu_drive_upload", "feishu_drive_import",
        ],
        "includes": []
    },
